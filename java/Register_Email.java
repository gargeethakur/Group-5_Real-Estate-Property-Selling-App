...
public class Register_Email extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize ProgressDialog correctly (Java syntax)
        ...
        // handle "Already have account?" click - go back to Login
        ...
        // handle register button click - start registration
    ...
    private void validateData() {
        ...
        if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
            ...
            binding.cPasswordEt.setError("Passwords don't match");
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        MyUtils.toast(Register_Email.this, "Failed due to " + e.getMessage());
        ...
        ref.child(registeredUserUid)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        startActivity(new Intent(Register_Email.this, MainActivity.class));
                        finishAffinity();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.e(TAG, "onFailure: ", e);
                        MyUtils.toast(Register_Email.this, "Failed to save due to " + e.getMessage());
                        progressDialog.dismiss();
                    }
                });
    }
